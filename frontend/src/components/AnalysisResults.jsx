...
function formatConfidence(prob) {
  ...
  return percentage >= 99.95 ? '99.9' : percentage.toFixed(1);
}
...
export default function AnalysisResults({
  ...
  const conditionDescription = conditionDescriptions[prediction?.toLowerCase()];
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-card overflow-hidden">
        <div className={clsx(
          'px-6 py-4 border-b',
          isHighConfidence ? 'bg-success-50 border-success-100' : 'bg-warning-50 border-warning-100'
        )}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={clsx(
                  ...
                  isHighConfidence ? 'text-success-700' : 'text-warning-700'
                )}>
            ...
            <div>
              ...
              <div className="mt-6 flex justify-center">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-700 border border-primary-200 rounded-lg hover:bg-primary-50 disabled:opacity-50 transition-colors duration-150"
                >
